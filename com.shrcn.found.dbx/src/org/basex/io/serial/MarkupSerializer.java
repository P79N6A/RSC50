...
import static org.basex.data.DataText.ATT1;
import static org.basex.data.DataText.ATT2;
import static org.basex.data.DataText.CDATA_C;
import static org.basex.data.DataText.CDATA_O;
import static org.basex.data.DataText.CHARSET;
import static org.basex.data.DataText.COMM_C;
import static org.basex.data.DataText.COMM_O;
import static org.basex.data.DataText.CONTENT;
import static org.basex.data.DataText.CONTENT_TYPE;
import static org.basex.data.DataText.DOCDECL1;
import static org.basex.data.DataText.DOCDECL2;
import static org.basex.data.DataText.DOCDECL3;
import static org.basex.data.DataText.DOCTYPE;
import static org.basex.data.DataText.ELEM_C;
import static org.basex.data.DataText.ELEM_O;
import static org.basex.data.DataText.ELEM_OS;
import static org.basex.data.DataText.ELEM_SC;
import static org.basex.data.DataText.E_2028;
import static org.basex.data.DataText.E_AMP;
import static org.basex.data.DataText.E_GT;
import static org.basex.data.DataText.E_LT;
import static org.basex.data.DataText.E_QUOT;
import static org.basex.data.DataText.HTML;
import static org.basex.data.DataText.HTTPEQUIV;
import static org.basex.data.DataText.META;
import static org.basex.data.DataText.PI_C;
import static org.basex.data.DataText.PI_O;
import static org.basex.data.DataText.PUBLIC;
import static org.basex.data.DataText.SYSTEM;
import static org.basex.data.DataText.V10;
import static org.basex.data.DataText.V40;
import static org.basex.data.DataText.V401;
import static org.basex.data.DataText.V50;
import static org.basex.io.serial.SerializerOptions.BYTE_ORDER_MARK;
import static org.basex.io.serial.SerializerOptions.CDATA_SECTION_ELEMENTS;
import static org.basex.io.serial.SerializerOptions.DOCTYPE_PUBLIC;
import static org.basex.io.serial.SerializerOptions.DOCTYPE_SYSTEM;
import static org.basex.io.serial.SerializerOptions.ENCODING;
import static org.basex.io.serial.SerializerOptions.ESCAPE_URI_ATTRIBUTES;
import static org.basex.io.serial.SerializerOptions.HTML_VERSION;
import static org.basex.io.serial.SerializerOptions.INCLUDE_CONTENT_TYPE;
import static org.basex.io.serial.SerializerOptions.MEDIA_TYPE;
import static org.basex.io.serial.SerializerOptions.OMIT_XML_DECLARATION;
import static org.basex.io.serial.SerializerOptions.STANDALONE;
import static org.basex.io.serial.SerializerOptions.SUPPRESS_INDENTATION;
import static org.basex.io.serial.SerializerOptions.UNDECLARE_PREFIXES;
import static org.basex.io.serial.SerializerOptions.VERSION;
import static org.basex.query.QueryError.SERENC_X_X;
import static org.basex.query.QueryError.SERNOTSUPP_X;
import static org.basex.query.QueryError.SERSTAND;
import static org.basex.query.QueryError.SERUNDECL;
