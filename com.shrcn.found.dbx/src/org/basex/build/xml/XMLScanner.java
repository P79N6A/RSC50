...
import static org.basex.build.BuildText.AFTERROOT;
import static org.basex.build.BuildText.ANY;
import static org.basex.build.BuildText.ATTCHAR;
import static org.basex.build.BuildText.ATTCLOSE;
import static org.basex.build.BuildText.ATTL;
import static org.basex.build.BuildText.BEFOREROOT;
import static org.basex.build.BuildText.CD;
import static org.basex.build.BuildText.CDATA;
import static org.basex.build.BuildText.CDATASEC;
import static org.basex.build.BuildText.CHARACTER;
import static org.basex.build.BuildText.CLOSING;
import static org.basex.build.BuildText.COMMDASH;
import static org.basex.build.BuildText.COMS;
import static org.basex.build.BuildText.COND;
import static org.basex.build.BuildText.CONE;
import static org.basex.build.BuildText.CONTCDATA;
import static org.basex.build.BuildText.DECLENCODE;
import static org.basex.build.BuildText.DECLSTANDALONE;
import static org.basex.build.BuildText.DECLSTART;
import static org.basex.build.BuildText.DECLVERSION;
import static org.basex.build.BuildText.DOCDECL;
import static org.basex.build.BuildText.DOCEMPTY;
import static org.basex.build.BuildText.DOCTYPE;
import static org.basex.build.BuildText.ELEM;
import static org.basex.build.BuildText.EMP;
import static org.basex.build.BuildText.ENCOD;
import static org.basex.build.BuildText.ENT;
import static org.basex.build.BuildText.ENT1;
import static org.basex.build.BuildText.ENTS;
import static org.basex.build.BuildText.ERRDT;
import static org.basex.build.BuildText.FIX;
import static org.basex.build.BuildText.ID;
import static org.basex.build.BuildText.IDR;
import static org.basex.build.BuildText.IDRS;
import static org.basex.build.BuildText.IGNO;
import static org.basex.build.BuildText.IMP;
import static org.basex.build.BuildText.INCL;
import static org.basex.build.BuildText.INVEND;
import static org.basex.build.BuildText.INVNAME;
import static org.basex.build.BuildText.INVPE;
import static org.basex.build.BuildText.ND;
import static org.basex.build.BuildText.NMT;
import static org.basex.build.BuildText.NMTS;
import static org.basex.build.BuildText.NOT;
import static org.basex.build.BuildText.NOTA;
import static org.basex.build.BuildText.NOWS;
import static org.basex.build.BuildText.PC;
import static org.basex.build.BuildText.PIRES;
import static org.basex.build.BuildText.PITEXT;
import static org.basex.build.BuildText.PUBID;
import static org.basex.build.BuildText.PUBLIC;
import static org.basex.build.BuildText.RECENT;
import static org.basex.build.BuildText.REQ;
import static org.basex.build.BuildText.SCANQUOTE;
import static org.basex.build.BuildText.SEMI;
import static org.basex.build.BuildText.STANDALONE;
import static org.basex.build.BuildText.SYSTEM;
import static org.basex.build.BuildText.TEXTENC;
import static org.basex.build.BuildText.TYPEAFTER;
import static org.basex.build.BuildText.UNCLOSED;
import static org.basex.build.BuildText.UNKNOWNPE;
import static org.basex.build.BuildText.VERS;
import static org.basex.build.BuildText.VERS10;
import static org.basex.build.BuildText.VERS11;
import static org.basex.build.BuildText.WRONGCHAR;
import static org.basex.build.BuildText.WSERROR;
import static org.basex.build.BuildText.XDECL;
import static org.basex.core.Text.COLS;
import static org.basex.core.Text.LINE_X;
import static org.basex.core.Text.NO;
import static org.basex.core.Text.SCANPOS_X_X;
import static org.basex.core.Text.YES;
...
import static org.basex.util.Token.letter;
import static org.basex.util.Token.letterOrDigit;
import static org.basex.util.Token.string;
import static org.basex.util.Token.token;
import static org.basex.util.Token.ws;
import static org.basex.util.XMLToken.getEntity;
import static org.basex.util.XMLToken.isChar;
import static org.basex.util.XMLToken.isStartChar;
import static org.basex.util.XMLToken.valid;
