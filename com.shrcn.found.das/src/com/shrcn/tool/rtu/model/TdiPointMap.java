 ...
 */
/**
 * $Log: TdiPointMap.java,v $ Revision 1.2 2013/04/01 03:00:51 cchun
 * Update:添加copy()
 * 
 * Revision 1.1 2012/11/07 12:00:38 cchun Update:修改计算器表达式和变量表
 * 
 */
public class TdiPointMap extends BaseCalcPoint {
	...
	public TdiPointMap(int id, int varnum, String varname, TDcaMx mx,
			TDcaSt st, TDcaCo co) {
