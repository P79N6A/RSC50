...
//		}
	...
	public static void main(String[] args) {
		try {
			...
			VTDGen vg = new VTDGen();
			String path = VtdTest.class.getResource("").getPath();
...
//				ap.selectXPath("/purchaseOrder/items");
				int i = -1;
...
//					long len = vn.getElementFragment();
//					int l = (int) (len >> 32);
//					// int l = vn.getTokenLength(i);
//					byte[] content = new byte[l + 1];
//					System.out.println("len ==> " + l);
//					System.arraycopy(ba, vn.getTokenOffset(i) - 1, content, 0,
//							l);
...
//					xm.insertAfterHead("\n<something/>");
					xm.insertAttribute(" aaa=\"111\"");
//					xm.updateToken(vn.getAttrVal("partNum"), "872-BB");
//					xm.insertBeforeTail("<something/>\n");
				}
				ap.selectXPath("/purchaseOrder/items/item/USPrice[.<40]/text()");
//				ap.selectXPath("/purchaseOrder/items/item[last()]/USPrice/text()");
//				String select = "/purchaseOrder/items/item[last()]/@partNum";
//				ap.selectXPath(select);
				while ((i = ap.evalXPath()) != -1) {
					// printElement(vn, i);
					xm.updateToken(i, "201");
//					System.out.println("partNum---" + vn.toString(vn.getAttrVal("partNum")));
//					String attName = select.substring(select.lastIndexOf("@") + 1);
//					System.out.println("partNum---" + vn.toString(vn.getAttrVal(attName)));
