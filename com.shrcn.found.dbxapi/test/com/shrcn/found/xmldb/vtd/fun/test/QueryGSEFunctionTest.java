...
import com.shrcn.found.xmldb.vtd.fun.QueryGSEFunction;
 ...
 */
public class QueryGSEFunctionTest {
	...
	public void testExec() {
		...
		List<Element> iedAps = (List<Element>) XMLDBHelper.callFunction(QueryGSEFunction.class, params);
