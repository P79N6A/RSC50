...
import com.shrcn.found.xmldb.vtd.fun.QueryMMSFunction;
 ...
 */
public class QueryMMSFunctionTest {
	@BeforeClass
	...
	public void testExec() {
		...
		List<Element> iedAps = (List<Element>) XMLDBHelper.callFunction(QueryMMSFunction.class, params);
