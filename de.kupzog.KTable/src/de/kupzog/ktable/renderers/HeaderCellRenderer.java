 ...
 */
public class HeaderCellRenderer extends DefaultCellRenderer {
    ...
    public static final Image IMAGE_ARROWDOWN = SWTX.loadImageResource(
            Display.getCurrent(), "/icons/table_arrow_down.png");
    ...
    public static final Image IMAGE_ARROWUP = SWTX.loadImageResource(
            Display.getCurrent(), "/icons/table_arrow_up.png");
    
    public static final Color COLOR_FIXEDBACKGROUND = Display.getCurrent().getSystemColor(SWT.COLOR_WIDGET_BACKGROUND);
    
    public static Color COLOR_BG_TOP = Display.getDefault().getSystemColor(SWT.COLOR_WHITE);
//    public static Color COLOR_BG_TOP = Display.getDefault().getSystemColor(SWT.COLOR_GRAY);
    public static Color COLOR_BG_BOTTOM = new Color(null, 205, 193, 231);
//    	Display.getDefault().getSystemColor(SWT.COLOR_DARK_GRAY); 
//    	new Color(null, 84, 165, 213);
...
//        gc.setBackground(COLOR_BG_BOTTOM);
//		gc.setForeground(COLOR_BG_TOP);
