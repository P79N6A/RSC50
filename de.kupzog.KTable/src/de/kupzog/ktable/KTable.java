...
//        borderColor = new Color(null, 84, 165, 213);
        borderColor = m_Display.getSystemColor(SWT.COLOR_DARK_GRAY);
        shell=new Shell();
...
//        System.out.println("draw table begin---------------");
        Rectangle rect = getClientArea();
        GC gc = event.gc;
...
//        System.out.println("draw table end---------------");
    }
...
//            	KTableCellRenderer renderer = m_Model.getCellRenderer(lastCol, row);
//            	if (renderer instanceof DefaultCellRenderer) {
//            		defaultRenderer.setBackground(((DefaultCellRenderer)renderer).getBackground());
//            	}
            	int rowHeight = m_Model.getRowHeight(row);
...
//        fromCol = (fromCol>valid.x)?fromCol:valid.x;
//        fromCol = valid.x;
        if (valid.y<fromRow)
            fromRow = valid.y;
        int moveLeft = 1;
...
//        System.out.println("fromCol_X=" + fromCol_X);
//        int cellCount = 0;
        for (int row = fromRow; row < toRow; row++) {
            // skipping non-visible:
            r = getCellRectIgnoreSpan(fromCol, row, fromCol_X);
//            System.out.println("r(" + r.x + ", " + r.y + ", " + r.width + ", "
//					+ r.height + ")");
...
//                System.out.println("loop index(" + col + "," + row + 
//				")");
                
//                if(fromCol==0 && fromRow==0) {
//                	System.out.println("index(" + col + "," + row + ")");
//            		System.out.println("r(" + r.x + ", " + r.y + ", " + r.width + ", "
//        					+ r.height + ")");
//                }
                // perform real work:
...
//        if(fromCol==2 && toCol==18)
//        	System.out.println("draw cell span " + cellCount);
    }
