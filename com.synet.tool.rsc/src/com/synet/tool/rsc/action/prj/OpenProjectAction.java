 ...
 */
public class OpenProjectAction extends ConfigAction {
	
	public OpenProjectAction(String title) {
		super(title);
	}

	@Override
	public void run() {
		EventManager.getDefault().notify(EventConstants.PROJECT_OPEN, null);
	}
