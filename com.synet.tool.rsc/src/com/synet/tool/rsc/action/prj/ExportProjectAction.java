 ...
 */
public class ExportProjectAction extends ConfigAction {
	
	public ExportProjectAction(String title) {
		super(title);
	}

	@Override
	public void run() {
		EventManager.getDefault().notify(EventConstants.PROJECT_OPEN_EXP, null);
	}
