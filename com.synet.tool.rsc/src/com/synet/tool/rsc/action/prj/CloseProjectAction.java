 ...
 */
public class CloseProjectAction extends ConfigAction {
	
	public CloseProjectAction(String title) {
		super(title);
	}

	@Override
	public void run() {
		EventManager.getDefault().notify(EventConstants.PROJECT_CLOSE, null);
	}
