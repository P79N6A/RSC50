...
public class SecPwrBrkEditor extends BaseConfigEditor {
	...
	public void initData() {
		...
		List<Tb1046IedEntity> ieds = secPwrBrkService.getIedList();
	...
	private void search() {
		...
		List<Tb1092PowerkkEntity> list = secPwrBrkService.getIotermListByIedParams(f1046Model, f1046Name);
		if (list != null) {
			table.setInput(list);
		}
	}
...
//		List<Tb1092PowerkkEntity> list = (List<Tb1092PowerkkEntity>) table.getInput();
