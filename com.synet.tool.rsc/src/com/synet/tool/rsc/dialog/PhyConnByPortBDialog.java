...
public class PhyConnByPortBDialog extends KTableEditorDialog {
	
	private DevKTable table;
	private PhyscialAreaService service;

	public PhyConnByPortBDialog(Shell parentShell, Object item) {
		...
		if (buttonId == OK) {
			if (table.getSelection() != null) {
				...
				if (item instanceof Tb1053PhysconnEntity) {
					((Tb1053PhysconnEntity)item).setTb1048PortByF1048CodeB(entity);
				} 
