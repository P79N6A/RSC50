...
public class ConvChk1Dialog extends KTableEditorDialog {
	...
	public ConvChk1Dialog(Shell parentShell, Object item) {
	...
	protected Control createDialogArea(Composite parent) {
		...
		SwtUtil.createLabel(composite, "确认信号：", SwtUtil.bt_gd);
	...
	private void initData() {
		...
		Tb1061PoutEntity poutEntity = circuit.getTb1061PoutByF1061CodeConvChk1();
		if(poutEntity == null) {
			oldData = "*初始值为空*";
		} else {
	...
	protected void buttonPressed(int buttonId) {
		if (buttonId == OK) {
			...
			if(selectionIndex > -1) {
				...
				circuit.setTb1061PoutByF1061CodeConvChk1(poutEntity);
