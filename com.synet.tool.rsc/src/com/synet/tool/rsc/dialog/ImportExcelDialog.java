...
public class ImportExcelDialog extends WrappedDialog {
	
	private int tableHeadRow;
	private Text txtTableHead;
	private Label labMsg;

	public ImportExcelDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		SwtUtil.createLabel(composite, "表头行数：", SwtUtil.bf_gd);
		txtTableHead = SwtUtil.createText(composite, SwtUtil.bf_gd);
