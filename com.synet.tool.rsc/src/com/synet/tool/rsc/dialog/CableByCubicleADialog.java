...
public class CableByCubicleADialog extends KTableEditorDialog {
	
	private DevKTable table;
	private PhyscialAreaService service;

	public CableByCubicleADialog(Shell parentShell, Object item) {
		...
		if (buttonId == OK) {
			if (table.getSelection() != null) {
				...
				if (item instanceof Tb1051CableEntity) {
					((Tb1051CableEntity)item).setTb1050CubicleByF1050CodeA(entity);
				} 
