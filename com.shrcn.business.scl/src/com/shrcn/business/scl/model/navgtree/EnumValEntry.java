 ...
 *
 */
public class EnumValEntry extends TreeEntryImpl {

	private static final long serialVersionUID = 1L;

	public EnumValEntry(String name) {
		super(name);
	}
	
	public EnumValEntry(String name, String toolTip, String iconName) {
