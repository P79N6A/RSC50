 ...
 *
 * Revision 1.1  2009/12/07 03:04:57  cchun
 * Update:添加信号关联全屏查看功能
 *
 ...
 *
 */
public class FullScreenView extends FullScreenDialog {
	 ...
	 * @param icon
	 */
	public FullScreenView(Shell parent, String title, Image icon, PDocument doc) {
