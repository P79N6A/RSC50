 ...
 * $Log$
 */
public abstract class WrappedTitleAreaDialog extends TitleAreaDialog {

	protected WrappedTitleAreaDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	private void setTitleBgs() {
		Control[] cts = new Control[] {
				(Label)ObjectUtil.getFieldValue(this, "titleLabel"),
				(Label)ObjectUtil.getFieldValue(this, "titleImageLabel"),
				(Text)ObjectUtil.getFieldValue(this, "messageLabel"),
				(Label)ObjectUtil.getFieldValue(this, "messageImageLabel"),
		};
		for (Control ct : cts) {
			ct.setBackground(UIConstants.Content_BG);
		}
	}
