 ...
 */
public class SCTPerspectiveSwitcher implements IWindowTrim {
...
//
//	private Object reorderListener;
	 ...
	 */
	public SCTPerspectiveSwitcher(IWorkbenchWindow window, CBanner topBar, int style) {
		this.window = window;
		this.topBar = topBar;
		this.style = style;
...
//		};
	...
	private void synParentField(String name, Object value) {
		try {
			Field f = ObjectUtil.getField(PerspectiveSwitcher.class, name);
	...
	public void createControl(Composite parent) {
		...
		synParentField("perspectiveBar", perspectiveBar);
	}
	...
	private void addPerspectiveShortcut(IPerspectiveDescriptor perspective,
		...
		PerspectiveBarContributionItem item = new SCTPerspectiveBarContributionItem(
...
//			((PerspectiveBarContributionItem) item).setSelection(selected);
			setSelection((PerspectiveBarContributionItem) item, selected);
		}
	}
...
//        IPerspectiveDescriptor selectedPerspective = getPerspective(pbci);
////        		pbci.getPerspective();
//
...
//	 * @param listener
//	 */
//	public void addReorderListener(Object listener) {
...
//	}
	...
	private IPerspectiveDescriptor getPerspective(PerspectiveBarContributionItem contribItem) {
		return (IPerspectiveDescriptor) ObjectUtil.getFieldValue(contribItem, "perspective");
	}
	
	private void select(PerspectiveBarContributionItem contribItem) {
		ObjectUtil.invoke(perspectiveBar, "select", 
				new Class<?>[] {PerspectiveBarContributionItem.class}, contribItem);
	}
	
	private void setSelection(PerspectiveBarContributionItem contribItem, boolean select) {
		ObjectUtil.invoke(contribItem, "setSelection", 
				new Class<?>[] {Boolean.TYPE}, select);
	}
}
