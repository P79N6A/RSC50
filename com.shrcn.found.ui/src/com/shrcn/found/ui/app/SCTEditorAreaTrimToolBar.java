 ...
 * $Log$
 */
public class SCTEditorAreaTrimToolBar extends EditorAreaTrimToolBar {

	private static final Color bgColor = UIConstants.Win_BG;
	private Composite clientArea;
	
	public SCTEditorAreaTrimToolBar(WorkbenchWindow wbw, LayoutPart editorArea, Composite clientArea) {
		super(wbw);
