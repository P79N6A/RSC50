...
public class MessageDialog extends IconAndMessageDialog {
    ...
    protected Control createDialogArea(Composite parent) {
    	GridLayout playout = (GridLayout) parent.getLayout();
    	playout.marginBottom = 3;
    	playout.marginRight = 3;
        // create message area
...
//    	return convertHorizontalDLUsToPixels(150);
    }
	...
	static String[] getButtonLabels(int kind) {
		...
		case QUESTION: {
			dialogButtonLabels = new String[] { "是",
					"否" };
			break;
		}
		case QUESTION_WITH_CANCEL: {
