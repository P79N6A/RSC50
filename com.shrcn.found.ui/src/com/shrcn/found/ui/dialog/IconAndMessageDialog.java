 ...
 * </p>
 */
public abstract class IconAndMessageDialog extends WrappedDialog {
	/**
	...
	protected Control createMessageArea(Composite parent) {
		...
		if (message != null) {
			...
			GridDataFactory
					...
					.grab(true, false)
					.hint(convertHorizontalDLUsToPixels(width),
